...
if __name__ == "__main__":
    ...
    es_callback = EarlyStopping(monitor='val_weighted_categorical_crossentropy', patience=PATIENCE)
    ...
    model.fit(model_input, y_train, sample_weight=train_mask, validation_data=val_data,
              batch_size=A.shape[0], epochs=NB_EPOCH, shuffle=False, verbose=2, callbacks=[es_callback, mc_callback])
    # test
